...
#ifndef MIR_TEST_DOUBLES_STUB_DISPLAY_REPORT_H_
#define MIR_TEST_DOUBLES_STUB_DISPLAY_REPORT_H_
...
struct StubDisplayReport : graphics::DisplayReport
{
    ...
    void report_vsync(unsigned int, graphics::Frame const&) override {}
...
#endif /* MIR_TEST_DOUBLES_STUB_DISPLAY_REPORT_H_ */
