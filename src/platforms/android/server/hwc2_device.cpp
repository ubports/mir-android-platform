...
bool mga::Hwc2Device::compatible_renderlist(RenderableList const& list)
{
    // if (list.empty())
    //     return false;
...
mga::Hwc2Device::Hwc2Device(std::shared_ptr<HwcWrapper> const& hwc_wrapper) :
    hwc_wrapper(hwc_wrapper)
{
}

bool mga::Hwc2Device::buffer_is_onscreen(mg::Buffer const& buffer) const
{
...
void mga::Hwc2Device::commit(std::list<DisplayContents> const& contents)
{
#ifdef ANDROID_CAF
...
std::chrono::milliseconds mga::Hwc2Device::recommended_sleep() const
{
    return recommend_sleep;
}

void mga::Hwc2Device::content_cleared()
{
    onscreen_overlay_buffers.clear();
}

bool mga::Hwc2Device::can_swap_buffers() const
{
    return true;
}
